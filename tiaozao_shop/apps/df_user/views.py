...
import apps.df_goods
from apps.df_goods.models import TypeInfo,GoodsInfo,GoodsContent,ContentChart
...
def findpwdView(request):
    ...
    if request.method=="POST":
        ...
        if user.uemail == email:
            ...
            send_status = send_mail(email_title, email_body, 'xxx@163.com', [email],fail_silently=False)
